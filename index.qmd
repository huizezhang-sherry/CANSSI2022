...
picture of things in different places 

:::{.notes}
Storage of spatial and temporal data is often split into different tables, which complicates spatio-temporal data analysis. Creating one table has the problem of inefficient memory use, due to repeated information, especially when large geometry objects are combined with frequent (daily or weekly) temporal data.
:::
...
I will would like to use all my data analysis toolkit built on top of tibble/ data.frame
